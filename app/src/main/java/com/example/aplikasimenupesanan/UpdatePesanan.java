...
public class UpdatePesanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM pesanan WHERE tanggal = '" +getIntent().getStringExtra("comot") + "'",null);
        cursor.moveToFirst();
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg1) {
                ...
                db.execSQL("update pesanan set tanggal='"+
                        etext2.getText().toString() +"',jam='"+
                        etext3.getText().toString()+"',nomor_meja='"+
                        etext4.getText().toString()+"'where kd_pesanan='" +
